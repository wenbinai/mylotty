package org.example.lotty.application.process.draw.impl;

import org.example.lotty.application.mq.producer.KafkaProducer;
import org.example.lotty.application.process.draw.IActivityDrawProcess;
import org.example.lotty.application.process.draw.req.DrawProcessReq;
import org.example.lotty.application.process.draw.res.DrawProcessResult;
import org.example.lotty.application.process.draw.res.RuleQuantificationCrowdResult;
...
import org.example.lotty.domain.activity.service.partake.IActivityPartake;
...
import org.example.lotty.domain.rule.service.engine.EngineFilter;
...
import org.example.lotty.domain.strategy.service.draw.IDrawExec;
import org.example.lotty.domain.support.ids.IIdGenerator;
